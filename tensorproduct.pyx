...
cpdef outer_and_add_density(np.float64_t [:] fr1,
                            np.float64_t [:,:] fthetaphi1,
                            np.float64_t [:,:,:] result1,
                            np.float64_t [:] fr2,
                            np.float64_t [:,:] fthetaphi2,
                            np.float64_t [:,:,:] result2,
                            np.float64_t [:] fr3,
                            np.float64_t [:,:] fthetaphi3,
                            np.float64_t [:,:,:] result3,
                            np.float64_t [:] fr4,
                            np.float64_t [:,:] fthetaphi4,
                            np.float64_t [:,:,:] result4,
                            np.float64_t [:] fr5,                      
                            np.float64_t [:] fr6,
                            np.float64_t [:,:] fthetaphi6,
                            np.float64_t [:,:,:] result5,
                            np.float64_t [:] fr7,
                            np.float64_t [:] fr8,
                            np.float64_t [:,:] fthetaphi8,
                            np.float64_t [:,:,:] result6,
                            double norm
                            ):
#~                             np.float64_t [:] fr9,
